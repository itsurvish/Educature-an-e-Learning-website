...
<body>
    ...
    <div class="error-contents text-center">
        <a class="error-logo" href="#   "><img src="images/Untitled-1.png" alt="Logo"></a>
        <div class="section-padding gray-bg">
            <h2 class="title">401</h2>
            <h3 style="color:crimson" >
              You are Not Authentication to Access this page before Login
            </h3> 
            <a href="login.php" class="btn btn-lg btn-danger mt-4">Try Login Now</a>
        </div>
    </div>
